        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          ...
          <div className="w-full md:w-1/2 text-left md:text-left space-y-6">
            ...
            <p className="text-md leading-relaxed text-gray-800 transition-all duration-500 hover:text-amber-700">
              ...
              <strong>te</strong>, meaning "hand"; thus karate means "empty
              hand." Adding the suffix <strong>-do</strong>, meaning "way" (
              <strong>karate-do</strong>), implies karate as a total way of life
              that goes well beyond self-defense applications. In traditional
